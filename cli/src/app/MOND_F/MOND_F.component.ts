...
/* set column headers at first line */
        if(!aoa[0]) aoa[0] = [];
            aoa[0][0]='Название ';
/* fill data to array */
        for(var i = 0; i < this.MOND_FArray.length; ++i) {
            if(!aoa[i+1]) aoa[i+1] = [];
            aoa[i+1][0]=this.MOND_FArray[i].Name;
        }
		/* generate worksheet */
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'MOND_F');
        

        wb.Props = {
            Title: "Организация::Филиал организации",
            Subject: "Организация::Филиал организации",
            Company: "master.bami",
