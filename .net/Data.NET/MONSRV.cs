...
namespace a_srv.models { 
 ...
 public class  MONSRV_INFO { // Описание сервера
	 ...
	 public List<MONSRV_MODEMS>  monsrv_modems { get; set; } // Модемы
	 public List<MONSRV_PORTS>  monsrv_ports { get; set; } // Ком порты
	[Required]
 ...
 public class  MONSRV_MODEMS { // Модемы
	...
	public string  CallType{ get; set; } // Тип вызова
	public string  INITSTRING{ get; set; } // Строка инициализации
 }
