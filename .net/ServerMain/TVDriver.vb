...
#Region "properties"
    ...
    Private mTransport As Guid
    Public Overridable Property Transport As Guid
        Get
            Return mTransport
        End Get
        Set(value As Guid)
...
#Region "Transport support"
    ...
    Public Overridable Function OpenPort(Optional ByRef aSocket As GRPSSocket = Nothing) As Boolean
        ...
        'End If
        If Transport.ToString() = "D57A9CFD-46B8-4763-4A44-08D6C2921B4D" Then
        ...
        End If
        If Transport.ToString() = "212E6CB6-BE9B-42A5-4A43-08D6C2921B4D" Then
...
#Region "MustOvverride_zone"
    ...
    Public MustOverride Function ReadArch(ByVal ArchType As Guid, ByVal ArchYear As Short,
