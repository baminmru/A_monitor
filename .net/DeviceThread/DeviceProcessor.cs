                        ...
                        else
                        {
                            ...
                            if (!SkipErr)
                            {
                                ...
                                if (tError != "")
                                {
                                    ...
                                    TvMain.SaveLog(id_bdc, Guid.Empty,"??", "Ошибка транспорта. " +tError);
                                 }
                                ...
                                else
                                {
                                    ...
                                    catch(System.Exception ex)
                                    {
                                        ...
                                        TvMain.SaveLog(id_bdc, archType_hour, "??",  "Ошибка преобразования даты (dnextcurr) :" + dr["dnextcurr"].ToString() + " " + ex.Message);
                                    }
                                    while (ddd < SrvDate)
                                    {
                                        ddd = ddd.AddHours(1);
                            ...
                            TvMain.SaveLog(id_bdc,archType_moment,"??","Снятие блокировки устройства");
                        }
                    }
                    else
                    {
                        TvMain.SaveLog(id_bdc, Guid.Empty,"??", "Тепловычислитель занят");
                        DeviceOK = false;
                    }
                    if (DeviceOK)
                    {
                            ...
                            if (TvMain.isConnected() == false)
                            {
                                ...
                                if(tError !=""){
                                    ...
                                    TvMain.SaveLog(id_bdc, Guid.Empty,"??", "Ошибка соединения. "+tError);
                                }
                            ...
                            {
                                TvMain.SaveLog(id_bdc, Guid.Empty,"??", "Соединение с тепловычислителем:OK");
                            }
...
#region                 "hour"
                        ...
                        catch(System.Exception ex)
                        {
                            ...
                            TvMain.SaveLog(id_bdc, archType_hour, "??", "Ошибка преобразования даты (dnexthour) :" + dr["dnexthour"].ToString() + " " + ex.Message);
                        }
                                            ...
                                            try
                                            {
                                                ...
                                                if (TvMain.CheckForArch(archType_hour, tempdate.Year, tempdate.Month, tempdate.Day, tempdate.Hour, id_bdc) == false)
                                                {
                                                    ...
                                                    if (str.Length == 0)
                                                    {
                                                        ...
                                                        TvMain.SaveLog(id_bdc, archType_hour, "??", "Ошибка чтения часового архива за дату:" + tempdate.ToString());
                                                    }
                                                    else
                                                    {
                                                        if (str.Substring(0, 6) != "Ошибка")
                                                        {
                                                            ...
                                                            {
                                                                TvMain.SaveLog(id_bdc, archType_hour, "??", "Часовой архив за дату:" + tempdate.ToString() + ":OK");
                                                        ...
                                                        {
                                                            TvMain.SaveLog(id_bdc, archType_hour, "??", "Ошибка чтения часового архива за дату:" + tempdate.ToString() + " " + str);
                                            ...
                                            if (TvMain.TVD.IsConnected())
                                            {
                                                ...
                                                if (TvMain.CheckForArch(archType_day, tempdate.Year, tempdate.Month, tempdate.Day, 0, id_bdc) == false)
                                                {
                                                    ...
                                                    if (str.Length == 0)
                                                    {
                                                        ...
                                                        TvMain.SaveLog(id_bdc, archType_day, "??", "Ошибка чтения суточного архива за дату:" + tempdate.ToString());
                                                    }
                                                    else
                                                    {
                                                        if (str.Substring(0, 6) != "Ошибка")
                                                        {
                                                            ...
                                                            if (TvMain.TVD.isArchToDBWrite)
                                                            {
                                                                TvMain.SaveLog(id_bdc, archType_day, "??", "Суточный архив за дату:" + tempdate.ToString() + ":OK");
                                                        ...
                                                        {
                                                            WarningReport("Прибор ID: " + dr["id_bd"].ToString() + " не прочтен архив за дату " + tempdate.ToString() + "\r\n" + str);
                                                            TvMain.SaveLog(id_bdc, archType_day, "??", "Ошибка чтения суточного архив за дату:" + tempdate.ToString() + " " + str);
                                        ...
                                        if (TvMain.TVD.IsConnected())
                                        {
                                            ...
                                            if (TvMain.CheckForArch(archType_day, tempdate.Year, tempdate.Month, tempdate.Day, 0, id_bdc) == false)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        WarningReport("Прибор ID: " + dr["id_bd"].ToString() + " " + str + tempdate.ToString());
                                                        TvMain.SaveLog(id_bdc, archType_day, "??", "Ошибка чтения суточного архива за дату:" + tempdate.ToString() + " " + str);
                                                    }
                                                }
                                            }
                                            else
                        ...
                        if (TvMain.TVD.IsConnected() && ccurr && ddd <= SrvDate)
                        {
                            ...
                            try
                            {
                                ...
                                if (str.Length == 0)
                                {
                                    ...
                                    TvMain.SaveLog(id_bdc, archType_moment, "??", "Ошибка чтения текущего архива");
                                }
                                else
                                {
                                    if (str.Substring(0, 6) != "Ошибка")
                                    {
                                        ...
                                        {
                                            TvMain.SaveLog(id_bdc, archType_moment, "??", "Текущий архив" + ":OK");
                                        ...
                                        TvMain.SaveLog(id_bdc, archType_moment, "??", "Ошибка чтения текущего архива " +str);
                        ...
                        if (TvMain.TVD.IsConnected() && csum && ddd <= SrvDate)
                        {
                            ...
                            try
                            {
                                ...
                                if (TvMain.LockDevice(id_bdc, 400,true))
                                {
                                    ...
                                    {
                                        // oops!
                                        TvMain.SaveLog(id_bdc, archType_total, "??", "Ошибка чтения итогового архива " );
                                    }
                                    else
                                    {
                                        if (str.Substring(0, 6) != "Ошибка")
                                        {
                                            ...
                                            {
                                                TvMain.SaveLog(id_bdc, archType_moment, "??", "Итоговый архив " + ":OK");
                                        ...
                                        {
                                            TvMain.SaveLog(id_bdc, archType_total, "??", "Ошибка чтения итогового архива " +str);
                                        }
                                    }
                                    //TvMain.UnLockDevice(id_bdc);
                                }
...
//                                    TvMain.SaveLog(id_bdc, archType_hour, "??", "Чтение пропущенных часовых ( " + missing.Rows.Count.ToString() +" записей)");
//                                }
...
//                                        {
//                                            WarningReport("Прибор ID: " + dr["id_bd"].ToString() + " " + str + tempdate.ToString());
//                                            TvMain.SaveLog(id_bdc, archType_hour, "??", "Ошибка чтения пропущенного часового архива за дату:" + tempdate.ToString());
//                                        }
//                                        else
//                                        {
//                                            if (str.Substring(0, 6) != "Ошибка")
...
//                                                    if (TvMain.TVD.isArchToDBWrite)
//                                                    {
//                                                            TvMain.SaveLog(id_bdc, archType_hour, "??", "Пропущенный часовой архив за дату:" + tempdate.ToString() + ":OK");
//                                                        TvMain.ClearDBArchString(archType_hour, tempdate.Year, tempdate.Month, tempdate.Day, tempdate.Hour, id_bdc);
//                                                        TvMain.WriteArchToDB();
//                                                    }
...
//                                {
//                                TvMain.LockDevice(id_bdc, 400 * missing.Rows.Count, true);
//                                    TvMain.SaveLog(id_bdc, archType_hour, "??", "Чтение пропущенных суточных ( " + missing.Rows.Count.ToString() + " записей)");
//                                }
...
//                                        {
//                                            WarningReport("Прибор ID: " + dr["id_bd"].ToString() + " " + str + tempdate.ToString());
//                                            TvMain.SaveLog(id_bdc, archType_day, "??", "Ошибка чтения пропущенного суточного архива за дату:" + tempdate.ToString());
//                                        }
//                                        else
//                                        {
//                                            if (str.Substring(0, 6) != "Ошибка")
...
//                                                    if (TvMain.TVD.isArchToDBWrite)
//                                                    {
//                                                        TvMain.SaveLog(id_bdc, archType_day, "??", "Пропущенный суточный архив за дату:" + tempdate.ToString() + ":OK");
//                                                        TvMain.ClearDBArchString(archType_day, tempdate.Year, tempdate.Month, tempdate.Day, 0, id_bdc);
//                                                        TvMain.WriteArchToDB();
//                                                    }
...
//                        #endregion "missing day"
 ...
 //                                           WarningReport("Прибор ID= " + dr["id_bd"].ToString() + " " + str + " " + tempdate.ToString());
 //                                           TvMain.SaveLog(id_bdc, archType_hour, "??", "Ошибка чтения  часового архива по запросу за дату:" + tempdate.ToString() + " " + str);
 ...
 //                                                   if (TvMain.TVD.isArchToDBWrite)
 //                                                   {
 //                                                       TvMain.SaveLog(id_bdc, archType_hour, "??", "Часовой архив по запросу за дату:" + tempdate.ToString() + ":OK");
 //                                                       TvMain.ClearDBArchString(archType_hour, tempdate.Year, tempdate.Month, tempdate.Day, tempdate.Hour, id_bdc);
 //                                                       TvMain.WriteArchToDB();
 //                                                       TvMain.QueryExec("delete from QLIST where QLISTID=" + missing.Rows[j]["QLISTID"].ToString());
 ...
 //                                           WarningReport("Прибор ID= " + dr["id_bd"].ToString() + " " + str + " " + tempdate.ToString());
 //                                           TvMain.SaveLog(id_bdc, archType_hour, "??", "Ошибка чтения  суточного архива по запросу за дату:" + tempdate.ToString() + " " + str);
 //                                           if (Convert.ToInt16(missing.Rows[j]["PROCESSED"]) < 9)
 //                                           {
 //                                               TvMain.QueryExec("update QLIST set processed=processed+1 where QLISTID=" + missing.Rows[j]["QLISTID"].ToString());
 //                                           }
 ...
 //                                                   if (TvMain.TVD.isArchToDBWrite)
 //                                                   {
 //                                                       TvMain.SaveLog(id_bdc, archType_day, "??", "Суточный архив по запросу за дату:" + tempdate.ToString() + ":OK");
 ...
 //                                               WarningReport("Прибор ID= " + dr["id_bd"].ToString() + " " + str + tempdate.ToString());
 //                                               TvMain.SaveLog(id_bdc, archType_day, "??", "Ошибка чтения суточного архива по запросу за дату:" + tempdate.ToString() + " " + str);
 //                                               if (Convert.ToInt16(missing.Rows[j]["PROCESSED"]) < 9)
 //                                               {
 //                                                   TvMain.QueryExec("update QLIST set processed=processed+1 where QLISTID=" + missing.Rows[j]["QLISTID"].ToString());
 //                                               }
 ...
 //                       #endregion
                        ...
                        TvMain.SaveLog(id_bdc, Guid.Empty,"??", "Закрытие канала. " + transpname);
        ...
        private void AnalizeDevice(DataRow dr)
        {
            ...
            //            TvMain.SaveLog(id_bdc, Guid.Empty,"??", "Анализ данных");
            //        }
            //        catch (System.Exception ex)
            //        {
            //            TvMain.SaveLog(id_bdc, Guid.Empty,"??", "Ошибка при Анализе данных: " + ex.Message );
            //        }
